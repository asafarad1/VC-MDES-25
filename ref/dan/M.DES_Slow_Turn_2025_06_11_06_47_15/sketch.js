...
function calculateWaveSteps() {
  ...
  // מיון לפי baseAngle — מהזווית הכי שלילית להכי חיובית
  lines.sort((a, b) => a.baseAngle - b.baseAngle);

  let angleGroupSize = PI / 24; // קבוצות של ~7.5 מעלות

  for (let l of lines) {
    l.waveStep = Math.floor((l.baseAngle + PI) / angleGroupSize);
  }
}
